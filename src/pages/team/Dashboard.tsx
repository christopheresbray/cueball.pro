                      ...
                      <List>
                        {upcomingMatches.map(match => (
                          <ListItem key={match.id} divider>
                            <ListItemText
                              primary={`vs ${getOpponentTeamName(match)}`}
                              secondary={
                                <>
                                  {match.scheduledDate ? format(match.scheduledDate.toDate(), 'EEEE, MMMM d, yyyy h:mm a') : 'Date TBD'}
                                  <br />
                    ...
                    {pastMatches.length === 0 ? (
                      ...
                      <List>
                        {pastMatches.map(match => {
                          ...
                          const resultColor = teamWins > opponentWins 
                            ? 'success.main' 
                            : teamWins < opponentWins 
                              ? 'error.main' 
                              : 'text.primary';
                              ...
                              <ListItemText
                                primary={
                                  <Box display="flex" justifyContent="space-between">
                                    <Typography>vs {getOpponentTeamName(match)}</Typography>
                                    <Typography color={resultColor}>{resultText}</Typography>
                                  </Box>
                                }
                                secondary={
                                  match.scheduledDate 
